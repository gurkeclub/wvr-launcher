...
use gtk::{
    Adjustment, ContainerExt, EditableSignals, Entry, EntryExt, Label, LabelExt, RadioButton,
...
pub fn build_video_view(relm: &Relm<InputConfigView>, model: &InputConfigViewModel) -> gtk::Box {
